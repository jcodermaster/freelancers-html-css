jQuery(document).ready(function () {
  ...
  jQuery("#edu-description").maxLength({
    ...
    onLimitOver: function () {
      jQuery("#edu-description").css("color", "red");
      jQuery(".chars-remaining2-container").css("color", "red");
    },
    onLimitUnder: function () {
      jQuery("#edu-description").css("color", "#000");
      jQuery(".chars-remaining2-container").css("color", "#000");
    },
  });
  jQuery("#experience-description").maxLength({
    ...
    maxHolder: ".chars-max2",
    onLimitOver: function () {
      jQuery("#experience-description").css("color", "red");
      jQuery(".chars-remaining2-container").css("color", "red");
    },
    onLimitUnder: function () {
      jQuery("#experience-description").css("color", "#000");
      jQuery(".chars-remaining2-container").css("color", "#000");
    },
  });
  jQuery("#user-edit-about").maxLength({
    ...
    maxHolder: ".chars-max2",
    onLimitOver: function () {
      jQuery("#user-edit-about").css("color", "red");
      jQuery(".chars-remaining2-container").css("color", "red");
    },
    onLimitUnder: function () {
      jQuery("#user-edit-about").css("color", "#000");
      jQuery(".chars-remaining2-container").css("color", "#000");
    },
  });
  jQuery("#job-description-edit").maxLength({
    ...
    maxHolder: ".chars-max2",
    onLimitOver: function () {
      jQuery("#job-description-edit").css("color", "red");
      jQuery(".chars-remaining2-container").css("color", "red");
    },
    onLimitUnder: function () {
      jQuery("#job-description-edit").css("color", "#000");
      jQuery(".chars-remaining2-container").css("color", "#000");
    },
  });
  ...
  jQuery("#business-edit-about-1").maxLength({
    ...
    maxHolder: ".chars-max2",
    onLimitOver: function () {
      jQuery("#business-edit-about-1").css("color", "red");
      jQuery(".chars-remaining2-container").css("color", "red");
    },
    onLimitUnder: function () {
      jQuery("#business-edit-about-1").css("color", "#000");
      jQuery(".chars-remaining2-container").css("color", "#000");
    },
  });
  jQuery("#business-edit-about").maxLength({
    ...
    maxHolder: ".chars-max2",
    onLimitOver: function () {
      jQuery("#business-edit-about").css("color", "red");
      jQuery(".chars-remaining2-container").css("color", "red");
    },
    onLimitUnder: function () {
      jQuery("#business-edit-about").css("color", "#000");
      jQuery(".chars-remaining2-container").css("color", "#000");
    },
  });
  ...
  jQuery(".add-job-hour span").click(function () {
    ...
    hourOutput +=
      '<div class="month-section month-section-last ' +
      jobDay +
      "-" +
      jobFromID +
      "-" +
...
function add_items(add_btn, item_name, appendHolder) {
  ...
  jQuery(add_btn).click(function () {
    ...
    var item_date_title = jQuery(item_name)
      .find(":selected")
      .attr("data-title");
    ...
    if (jQuery(appendHolder).hasClass(item_input_id)) {
      ...
      jQuery(appendHolder).append(
        '<div class="college-art skills-item ' +
          item_date_title +
          '" data-index="' +
          item_input_id +
          '" data-name="' +
          item_date_title +
          '"><div class="modern-bachlor-text"><h5><b>' +
          item_name_input +
          '</b></h5></div><div class="icon-close delete-skill"><span><i class="fas fa-times"></i></span></div></div>'
      );
